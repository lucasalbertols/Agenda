...
namespace DesafioTechZoe.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,IsCompleted")] TaskModel task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,IsCompleted")] TaskModel task)
        {
            if (id != task.Id)
            {
                return View("NotFound");
